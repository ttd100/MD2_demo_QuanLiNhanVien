...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1.nhập thông tin từ các nhân viên");
            System.out.println("2.tính lương các nhân viên");
            System.out.println("3.hiển thị thông tin các nhân viên");
            System.out.println("4.Tim các nhân viên theo ki tu bat dau");
            System.out.println("5.sắp xếp nhân viên theo lương giảm dần");
